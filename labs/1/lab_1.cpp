 ...
 * Description : Incredible Program
=======
 * Author      : FILL IN
 * Description : FILL IN
...
<<<<<<< HEAD
  ...
  char programmed_before, my_character;
  programmed_before = 'z';
  my_character = 'z';

  // (3) Display a welcome message to standard output
  cout << "Welcome to this incredible program!" << endl;
  ...
  cout << "Have you ever programmed before, " << user_name <<
  "? Please input your answer via the letters 'y' or 'n'." << endl;
